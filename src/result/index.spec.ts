/**
 * Use JEST library for this test.
 */

 import { Result } from './'

 class TestClass {
   public async execute(_obj: any): Promise<Result<TestClass>> {
 ...
 const makeExecuteSpy = (testClass: TestClass) => {
   jest
     .spyOn(testClass, 'execute')
     .mockImplementationOnce(async (_obj: any): Promise<Result<TestClass>> => {
